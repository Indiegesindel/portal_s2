using Indiegesindel.PortalS2.Mechanics;
using Sandbox;
using System.Linq;
...
public partial class Player : AnimatedEntity
{
	...
	/// </summary>
	[Net] public TimeSince TimeSinceDamage { get; set; }
	...
	public override void ClientSpawn()
	{
		...
		/*var viewModelEntity = new BaseViewModel { Owner = Owner, EnableViewmodelRendering = true };
		viewModelEntity.SetModel( "weapons/rust_pistol/v_rust_pistol.vmdl" );*/
